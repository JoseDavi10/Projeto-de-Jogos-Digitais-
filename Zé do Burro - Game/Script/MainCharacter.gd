...
# pré-carregamento das cenas de armas
var spear = preload("res://Golpes/Spear.tscn");
var axe = preload("res://Golpes/Axe.tscn")
var dagger = preload("res://Golpes/Dagger.tscn")
